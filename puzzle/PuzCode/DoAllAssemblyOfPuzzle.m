function [GI, GR, im, Results, i_,time1,time2] = DoAllAssemblyOfPuzzle(greedyOrder,ap,SCO,nr,nc,RotFlag,PositionKey,mni)
%function [GI, i_, Blocks] = DoAllAssemblyOfPuzzle(greedyOrder,ap,SCO,nr,nc,RotFlag,PositionKey,mni)
...
elseif(nargin<6)
    PositionKey = randperm(nr*nc); 
        ...
        %[G_,i_,GR] = GreedyAssembly5R(greedyOrder,ap,SCO, nr,nc);
        [G_,i_,GR,~,~,GI, Blocks,time1,time2] = GreedyAssembly5R(greedyOrder,ap,SCO, nr,nc,mni);
